...
def draw_wheels(screen, robot):
    ...
    left_wheel_center = [
        robot.position[0] - wheel_offset * math.cos(rad_angle),
        robot.position[1] - wheel_offset * math.sin(rad_angle),
    ]
    right_wheel_center = [
        robot.position[0] + wheel_offset * math.cos(rad_angle),
        robot.position[1] + wheel_offset * math.sin(rad_angle),
...
def draw_link(screen, robot):
    ...
    link_end = [
        robot.position[0] + robot.link_length * math.cos(rad_angle),
        robot.position[1] + robot.link_length * math.sin(rad_angle),
    ]
